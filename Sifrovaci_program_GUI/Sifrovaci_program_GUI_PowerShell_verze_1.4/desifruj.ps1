...
# odsud upraveno 16.1.2025 bezmaticove <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
#$nalezene_heslo="" # jiz obsazeno vyse
$nalezene_heslo_2 = ""
$poc_heslo = 0
$heslo_pro_rozpakovani=""


for ( $kk5 = 0 ; $kk5 -le 252 - 2; $kk5 = $kk5 + 2 ){
#echo $kk5
$dvojice_heslo = $nalezene_heslo.Substring($kk5,2)
...
# TEST
#$vysledek_int = 0 # test = 00
#$vysledek_int = 1 # test = 01
#$vysledek_int  = 3842 # test 3843 = ZY
#$vysledek_int = 3843 # test = ZZ


$nalezene_heslo_2 += [string] $vysledek_int
if ( $kk5 -ne 250 ) { $nalezene_heslo_2 += ","}
...
$jeden_znak = ($stream_reader_1.ReadLine())
#echo $jeden_znak---
...
#echo $jeden_znak # "<<"
#echo "$poc_znaky - $jeden_znak"
$heslo_pro_rozpakovani += $jeden_znak
...
$preskoc_radek = ($stream_reader_1.ReadLine())
}
